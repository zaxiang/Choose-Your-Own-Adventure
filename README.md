...
4.  First, print the text of the page, exactly as it appeared in the input
    file.
5.  Next, print a blank line.
6.  Then print either
...
Hint: You should write cyoa-step1.cpp with _as little_ code in it as
...
3.  After reading all pages, your program should verify the following
    ...
    story).
    3b. Every page (except page 0) is referenced by at least one _other_
...
5.  As with Steps 1 and 2, the program will take a directory as a
    ...
    now, right?)
6.  The program should then determine all possible cycle-free winning
    ...
    would display as 1.<UNAVAILABLE>
    2.Squirt the eclair filling in the dragon's eye. 3.<UNAVAILABLE>
